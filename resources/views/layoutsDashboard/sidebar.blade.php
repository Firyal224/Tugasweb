<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="transform: translateY(-20px)">

      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon rotate-n-15">
          <i class="fa fa-address-card user-profile-icon"></i>
        </div>
      ...
      @role('admin')
          ...
          <li class="nav-item @yield('user-active')">
            ...
            <div id="user" class="collapse @yield('user')" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item @yield('penulis')" href="#">tes</a>
                <a class="collapse-item @yield('pembaca')" href="#">tes2</a>
              </div>
            </div>
          </li>
      @endrole
